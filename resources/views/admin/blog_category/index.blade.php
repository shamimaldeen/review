              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $category->name }}</td>
                    <td>
                      <a href="{{ route('admin.blog_category.edit',$category->id) }}"><i class="fa fa-edit btn btn-primary"></i></a>



                      <a href="{{ route('admin.blog_category.destroy',$category->id) }}"
                        ...
                        <form id="blog-category-delete-form" action="{{ route('admin.blog_category.destroy',$category->id) }}" method="POST" style="display: none;">
                         @method('DELETE')
                         {{--  @csrf --}}
                         {{ csrf_field() }}
                       </form>
